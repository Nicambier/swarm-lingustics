...
AgentFactory::AgentFactory(int type, double p1, double p2) : type(type), p1(p1), p2(p2), weak(false)
{
...
Agent* AgentFactory::GetNewAgent(World* w, Vector2D pos)
{
    ...
    case TYPE_AGENT:
        ...
        break;
    case TYPE_AGG_AGENT:
        return new AggregationAgent(w, pos, p1, p2);
        break;
    case TYPE_NG_AGG_AGENT:
        return new NgAggAgent(w, pos, p1, p2, weak);
        break;
    case TYPE_EE_AGG_AGENT:
        return new EeAggAgent(w, pos, p1, weak);
        break;
